...
% Fix bibliography overflow: allow extra stretch in bib entries to prevent overfull hboxes
% Long conference/journal names can overflow without this
...
\BeforeTOCHead[toc]{{\clearpage\pdfbookmark[0]{\contentsname}{toc}}}
