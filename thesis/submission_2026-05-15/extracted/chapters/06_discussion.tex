...
\section{Stratified UQ: Why \texorpdfstring{$\rho$}{ρ} Drops on Large \texorpdfstring{$|\Delta v|$}{|Δv|}}\label{sec:stratified_why}
...
T10/T11 share head, loss, data, calibration, and LR. One untested alternative: the inherited LR ($5\times10^{-4}$) may be too high for fine-tuning a converged backbone. Cross-architecture and cross-dataset replication left for future work. \\
\midrule
