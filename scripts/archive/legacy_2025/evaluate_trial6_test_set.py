...
MODEL_DIR = f"{BASE_PATH}/data/TR-C_Benchmarks/point_net_transf_gat_6th_trial_lower_lr"

# ============================================================================
# LOAD MODEL
# ============================================================================
print("="*80)
print(" LOADING MODEL - 6TH TRIAL (LOWER LEARNING RATE)")
print("="*80)
...
print(f"{'-'*50}")
print(f"{'R² Score':<20} {0.5224:<15.4f} {r2:<15.4f}")
print(f"{'Pearson':<20} {0.7255:<15.4f} {pearson_r:<15.4f}")
print(f"{'Spearman':<20} {0.1921:<15.4f} {spearman_r:<15.4f}")
print(f"{'Loss (MSE)':<20} {57.576:<15.3f} {avg_test_loss:<15.3f}")
...
# ============================================================================
# COMPARISON WITH TRIAL 5
# ============================================================================
print(f"\n{'='*40}")
print(f"  COMPARISON WITH TRIAL 5 (BEST MODEL)")
print(f"{'='*40}")
print(f"{'Metric':<20} {'Trial 5':<15} {'Trial 6':<15} {'Difference':<15}")
print(f"{'-'*65}")
...
print(f"{'Learning Rate':<20} {'5e-4':<15} {'3e-4':<15} {'-40%':<15}")
...
ax.set_title('Learning Rate Experiment Comparison', fontsize=14, fontweight='bold')
ax.set_ylim(0, 0.85)
ax.legend(fontsize=11)
ax.grid(True, alpha=0.3, axis='y')
...
plt.suptitle('6th Trial (Lower LR) - Test Set Evaluation', 
...
print("="*80)
print("\nNEXT STEP: Compare Trial 6 results with Trial 5 to determine best model")
