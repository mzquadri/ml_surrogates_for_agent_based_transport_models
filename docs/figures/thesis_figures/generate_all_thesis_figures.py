...
def fig2_uq_ranking():
    ...
    # Corrected values after PyG weight-remapping fix (100 graphs, 3.16M nodes)
    rho = [0.4263, 0.4186, 0.4460, 0.4820, 0.4908, 0.4370, 0.4909, 0.4333]
    colors = ([P_BLUE] * 4) + ([P_AMBER] * 4)
    # Highlight best bars in each panel with coral
    colors[3] = P_CORAL  # T8 standalone — best in left panel
    colors[6] = P_CORAL  # Exp A Combined — best in right panel
